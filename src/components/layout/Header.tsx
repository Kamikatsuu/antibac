      ...
      {showDigitalCardModal && currentUser && (
        ...
        >
          <div
            ...
            className="relative my-auto bg-stone-900 border border-stone-700/90 rounded-2xl sm:rounded-3xl p-4 sm:p-6 max-w-lg w-full text-white shadow-2xl max-h-[90vh] overflow-y-auto animate-in zoom-in-95"
